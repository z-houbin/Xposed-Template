...
public class StreamGobbler extends Thread {
  ...
  public interface OnLineListener {
     ...
     * native process or even type in a deadlock</p>
     *
     * @param line
   ...
   *
   * <p>We use this class because shell STDOUT and STDERR should be readConfig as quickly as possible to prevent a
   * deadlock from occurring, or Process.waitFor() never returning (as the buffer is full, pausing the native
   * process)</p>
   *
   * @param inputStream
   *     InputStream to readConfig from
   * @param outputList
